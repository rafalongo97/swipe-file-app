        ...
        >
          ...
          >
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/40 px-6 py-4 flex flex-col gap-3">
              ...
              <button
                onClick={() => setOfertaSelecionada(null)}
                className="w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-755 text-gray-700 dark:text-gray-300 text-center font-bold py-2.5 px-4 rounded-lg text-sm transition cursor-pointer"
              >
                Fechar Detalhes
              </button>
            </div>

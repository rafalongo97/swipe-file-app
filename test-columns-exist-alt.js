...
async function run() {
  await testColumn('valores_order_bump');
  await testColumn('valor_order_bumps');
  await testColumn('valor_order_bump');
  await testColumn('valores_bumps');
  await testColumn('bumps');
}
